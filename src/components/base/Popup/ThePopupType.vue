...
<div>
    ...
    titlePopup="CUKCUK - Quản lý nhà hàng" >
        <template v-slot:dialogText> 
            <div class="dialog__text">
                Bạn có chắc chắn muốn xoá món <span>&lt; {{foodCode}} - {{foodName}}  &gt;</span> không ? 
            </div>
        </template>
        <div class="dialog__footer flex flex-items-center flex-row-reverse ">
            <BaseButton class="btn-default-cukcuk btn-hover" text="Không" @click="handleCancel" />
            <BaseButton class="btn-default-cukcuk btn-hover" text="Có" @click="handleAccept" />
    ...
    titlePopup="CUKCUK - Quản lý nhà hàng"
     >
        <template v-slot:dialogText> 
            <div class="dialog__text">
                Mã <span>&lt; {{foodCode}} &gt;</span> đã tồn tại trên một trong các danh sách sau: Món ăn, đồ uống, combo, món khác, dịch vụ tính tiền theo thời gian. 
            </div>
        </template>
        <div class="dialog__footer flex flex-items-center flex-row-reverse ">
            <BaseButton class="btn-default-cukcuk btn-hover" text="Đồng ý" @click="handleCancel" />
        </div>
    </ThePopup>
    ...
    :titlePopup="titlePopup.changeTitle" >
    <template v-slot:iconClose  >
            <div class="icon icon-close icon-24 cursor-pointer" id="btnClose" 
            @click="handleCancel"
            ></div>
        ...
        <div class="dialog__footer flex flex-items-center flex-row-reverse ">
        <BaseButton class="btn btn-green" text="Có" @click="handleAccept" />
        <BaseButton class="btn btn-normal-default" text="Không" @click="handleUnAccept" />
